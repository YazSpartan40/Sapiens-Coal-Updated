...
function mod:onload(fuel_)
    mj:log("Charcoal: Adding charcoal fuel values")
    ...
    if fuel_.fuelGroups.campfire and fuel_.fuelGroups.campfire.resources then
        ...
        mj:log("Charcoal: Added charcoal to campfire fuel group with 5.0 fuel addition")
    end
    ...
    if fuel_.fuelGroups.kiln and fuel_.fuelGroups.kiln.resources then
        ...
        mj:log("Charcoal: Added charcoal to kiln fuel group with 5.0 fuel addition")
    end
    ...
    if fuel_.fuelGroups.litObject and fuel_.fuelGroups.litObject.resources then
        ...
        mj:log("Charcoal: Added charcoal to litObject fuel group with 5.0 fuel addition")
    end

    mj:log("Charcoal: Fuel integration complete")
end
